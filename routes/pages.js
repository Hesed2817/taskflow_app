...
// Dashboard
router.get('/dashboard', protect, async function (request, response) {
    try {
...
// Project details
router.get('/projects/:id', protect, async function (request, response) {
    try {
        const Project = require('../models/Project');
        const Task = require('../models/Task');
...
// Edit project
router.get('/projects/:id/edit', protect, async function (request, response) {
    try {
        const Project = require('../models/Project');
...
// Project settings
router.get('/projects/:id/settings', protect, async function (request, response) {
    try {
        const Project = require('../models/Project');
...
// All Tasks
router.get('/tasks', protect, async function (request, response) {
    try {
        const Task = require('../models/Task');
        const Project = require('../models/Project');
...
// Task edit page
router.get('/tasks/:id/edit', protect, async function (request, response) {
    try {
        const Task = require('../models/Task');
        const Project = require('../models/Project');
...
router.get('/projects/:id/tasks', protect, async function (request, response) {
    try {
        const Project = require('../models/Project');
        const Task = require('../models/Task');
...
// Profile
router.get('/profile', protect, async function (request, response) {
    try {
        const Project = require('../models/Project');
        const Task = require('../models/Task');
...
// Logout
router.get('/logout', protect, function (request, response) {
